...
<head>
    ...
    <!-- Title -->
    <title>DulichVN - {{ $title }}</title>
    <!-- Favicon Icon -->
    <link rel="shortcut icon" href="{{ asset('clients/assets/images/logos/logo_dulichVN.png') }}" type="image/x-icon">
    <!-- Google Fonts -->
                    ...
                    <div class="header-inner rel d-flex align-items-center">
                        <div class="logo-outer">
                            <div class="logo"><a href="{{ route('home') }}"><img
                                        src="{{ asset('clients/assets/images/logos/logo_dulichVN.png') }}" alt="Logo"
                                        title="Logo" style="width: 65px;"></a></div>
                        </div>
