        ...
        <div class="row justify-content-center">
            <div class="col-xl-3 col-lg-4 col-sm-6">
                <div class="team-item hover-content" data-aos="fade-up" data-aos-duration="1500" data-aos-offset="50">
                    <img src="{{ asset('clients/assets/images/team/Clorinde.600.4036664.jpg') }}" alt="Guide">
                    <div class="content">
                        <h6>TUNG NT</h6>
                        <span class="designation">Founder</span>
                        <div class="social-style-one inner-content">
                            <a href="https://www.facebook.com/hackgametung"><i class="fab fa-twitter"></i></a>
                            <a href="https://www.facebook.com/hackgametung"><i class="fab fa-facebook-f"></i></a>
                            <a href="https://www.facebook.com/hackgametung"><i class="fab fa-instagram"></i></a>
